...
class simplePyCLI:
    def __init__(self, cli_symbol: str = "~"):
        self.commands = (
            {}
        )  # Dictionary to store commands and their corresponding actions
        ...
        self.add_command(
            "toggle_debug", self._toggle_debug, 0, "Toggle short/long replay messages"
        )
    ...
    def add_command(
        self, command: str, action, max_params: int = 3, description: str = ""
    ):
        """
        ...
        self.commands[command] = (
            ...
            max_params,
            description,
        )  # Store the action and maximum parameters for the command
        # print(self.commands)
